            ...
            for title in titles:
                ...
                try:
                    ...
                    if text.strip() == translatedContent.strip():
                        pywikibot.output(u'The template is still clean, no change necessary.')
                    elif subst and sandboxPage.userName() == mySite.loggedInAs():
                        pywikibot.output(u'The template might be clean, no change necessary.')
                        ...
                        if self.user:
                            ...
                            pywikibot.output(u'Standard content was changed, template cleaned.')
                    else:
