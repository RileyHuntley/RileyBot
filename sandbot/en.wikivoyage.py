            ...
            for title in titles:
                ...
                try:
                    ...
                    if text.strip() == translatedContent.strip():
                        ...
                        pywikibot.output(u'en.wikivoyage: The graffiti wall might be clean, no change necessary.')
                        ...
                        if self.user:
                            ...
                            pywikibot.output(u'en.wikivoyage: Standard content was changed, graffiti wall cleaned.')
                    else:
